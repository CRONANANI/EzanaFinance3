...
const QUIZ_BANK = {
  'stocks-intermediate-4': [
    ...
    },
    {
      ...
      options: ['Energy', 'Utilities', 'Financials', 'Materials'],
      correct: 1,
      explanation:
  ...
  'stocks-advanced-1': [
    ...
    },
    {
      ...
      options: ['In-the-money', 'Out-of-the-money', 'Deep-in-the-money', 'At-the-money'],
      correct: 3,
      explanation:
  ...
  'betting-intermediate-6': [
    ...
    },
    {
      ...
      options: ['Always understate skill', 'Have no effect', 'Overstate edge', 'Replace CLV'],
      correct: 2,
      explanation:
  ...
  'commodities-intermediate-1': [
    ...
    },
    {
      ...
      options: ['$7,500', '$750,000', '$75', '$75,000 (1,000 bbl)'],
      correct: 3,
      explanation:
