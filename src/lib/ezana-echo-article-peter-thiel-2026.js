...
export const peterThiel2026 = {
  ...
  contentBlocks: [
    ...
    {
      type: 'paragraph',
      text: "For an investor, philosophy is only actionable where it touches capital, and Thiel's does so directly through Palantir Technologies, the data-analytics firm he co-founded in 2003. Palantir's core business is integrating and analyzing large datasets for government and, increasingly, commercial clients, and its growth has been driven substantially by federal contracts tied to the same defense and intelligence priorities championed by figures in the Dialog network. Thiel was also an early backer of Facebook (now Meta) and a co-founder of PayPal, seeding the so-called 'PayPal Mafia' whose members went on to found or fund Tesla, SpaceX, LinkedIn, YouTube, and Palantir itself. The practical point for a younger investor is concentration: a remarkably small group of people, bound by shared ideology and personal ties, holds outsized influence over the platforms, defense systems, and increasingly the political appointments that define the era.",
    },
    {
      type: 'chart',
    ...
    {
      type: 'paragraph',
      text: "A recurring theme in Thiel's life is exit — the option to leave rather than to fix. He holds citizenship or residency across multiple countries, has pursued additional passports, and has reportedly shifted parts of his life toward Argentina, courting President Javier Milei and acquiring land in the region, on the stated reasoning that the area is insulated from nuclear conflict and AI catastrophe. The irony that critics highlight is pointed: the risks Thiel is hedging against — runaway AI, geopolitical instability — are precisely the risks his own companies and investments help accelerate. For a generation that cannot buy its way to a bunker in a war-insulated hemisphere, the 'exit' philosophy reads differently than it does for a billionaire. The young inherit the system; they do not get to escape it.",
    },
    {
      type: 'paragraph',
