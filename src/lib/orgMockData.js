...
export const MOCK_MEMBERS = [
  ...
  },
  {
    ...
    name: 'Priya Sharma',
    role: 'executive',
    sub_role: 'VP of Research',
    team_id: null,
    email: 'psharma@ezanatest.edu',
    avatar: null,
  },
  // Noah — real test account mapped to executive role
  {
    id: 'm25',
    name: 'Noah Raymond-Leigh',
    role: 'executive',
    sub_role: 'VP of Operations',
    team_id: null,
    email: 'noah@raymondleigh.com',
    avatar: null,
  },
  ...
  },
  {
    ...
    sub_role: 'PM',
    team_id: 't4',
    email: 'srodriguez@ezanatest.edu',
    avatar: null,
  },
  {
    id: 'm7',
  ...
  },
  {
    ...
    sub_role: 'Junior PM',
    team_id: 't5',
    email: 'zwashington@ezanatest.edu',
    avatar: null,
  },
  {
    id: 'm9',
  ...
  // ═══ Analysts — TMT (expanded) ═══
  {
    ...
    name: 'Emma Liu',
    role: 'analyst',
    sub_role: 'Senior Analyst',
    team_id: 't7',
    email: 'eliu@ezanatest.edu',
    avatar: null,
  },
  {
    id: 'm11',
  ...
  },
  {
    ...
    name: 'Chloe Martin',
    role: 'analyst',
    sub_role: 'Junior Analyst',
    team_id: 't7',
    email: 'cmartin@ezanatest.edu',
    avatar: null,
  },
  // Blackberry — real test account mapped to analyst on TMT
  {
    id: 'm20',
    name: 'Blackberry Analyst',
    role: 'analyst',
    sub_role: 'Analyst',
    team_id: 't7',
    email: 'blackberry4567712@gmail.com',
    avatar: null,
  },
  {
    id: 'm21',
    ...
    sub_role: 'Senior Analyst',
    team_id: 't7',
    email: 'rvenkatesh@ezanatest.edu',
    avatar: null,
  },
  {
    id: 'm22',
    ...
    role: 'analyst',
    sub_role: 'Quantitative Analyst',
    team_id: 't7',
    email: 'snakamura@ezanatest.edu',
    avatar: null,
  },
  {
    id: 'm23',
...
export const MOCK_EVENTS = [
  ...
  // ─── NEW TMT Events ───
  {
    ...
    created_by: 'm25',
    description:
      'TMT analysts present semiconductor thesis covering NVDA, AMD, AVGO, and TSM with focus on AI infrastructure capex cycle.',
    deliverables: [
      {
        name: 'Semiconductor Thesis Deck',
        type: 'pptx',
        status: 'in_progress',
        assigned_to: 'm21',
      },
  ...
  },
  {
    ...
    created_by: 'm3',
    description:
      'Review of media and streaming holdings — NFLX, DIS, SPOT, PARA — and evaluation of ad revenue trends.',
    deliverables: [
...
export const MOCK_TASKS = [
  ...
  {
    id: 'tk2',
    title: 'Write one-page primer for MSFT',
    team_id: 't7',
    assigned_to: 'm11',
    assigned_by: 'm3',
    status: 'in_progress',
  ...
  {
    id: 'tk3',
    title: 'Research AAPL supply chain risks',
    team_id: 't7',
    assigned_to: 'm12',
    assigned_by: 'm3',
    status: 'pending',
  ...
  {
    id: 'tk4',
    title: 'Update TMT sector watchlist',
    team_id: 't7',
    assigned_to: 'm11',
    assigned_by: 'm3',
    status: 'completed',
  ...
  {
    id: 'tk5',
    title: 'Analyze UNH earnings report',
    team_id: 't1',
    assigned_to: 'm13',
    assigned_by: 'm4',
    status: 'in_progress',
  ...
  {
    id: 'tk6',
    title: 'Draft sector analysis report',
    team_id: 't1',
    assigned_to: 'm14',
    assigned_by: 'm4',
    status: 'pending',
  ...
  {
    id: 'tk8',
    title: 'Run comparable analysis for JPM/GS/MS',
    team_id: 't4',
    assigned_to: 'm16',
    assigned_by: 'm6',
    status: 'pending',
  ...
  {
    id: 'tk9',
    title: 'Build AMD comparable company model',
    team_id: 't7',
    assigned_to: 'm20',
    assigned_by: 'm3',
    status: 'in_progress',
  ...
  {
    id: 'tk10',
    title: 'Analyze META ad revenue vs GOOGL trends',
    team_id: 't7',
    assigned_to: 'm20',
    assigned_by: 'm3',
    status: 'pending',
  ...
  {
    id: 'tk11',
    title: 'Research AVGO VMware integration synergies',
    team_id: 't7',
    assigned_to: 'm22',
    assigned_by: 'm3',
    status: 'in_progress',
  ...
  {
    id: 'tk12',
    title: 'Build NFLX subscriber growth model',
    team_id: 't7',
    assigned_to: 'm20',
    assigned_by: 'm3',
    status: 'pending',
  ...
  {
    id: 'tk13',
    title: 'Write TSM one-page primer',
    team_id: 't7',
    assigned_to: 'm23',
    assigned_by: 'm3',
    status: 'pending',
  ...
  {
    id: 'tk14',
    title: 'Update TMT team watchlist with AI infrastructure names',
    team_id: 't7',
    assigned_to: 'm24',
    assigned_by: 'm3',
    status: 'completed',
  ...
  {
    id: 'tk15',
    title: 'Prepare streaming comps table (NFLX, DIS, SPOT, PARA)',
    team_id: 't7',
    assigned_to: 'm23',
    assigned_by: 'm3',
    status: 'pending',
  ...
  {
    id: 'tk16',
    title: 'Draft semiconductor thesis summary slide',
    team_id: 't7',
    assigned_to: 'm21',
    assigned_by: 'm3',
    status: 'in_progress',
...
export const EXECUTIVE_TASKS = [
  {
    id: 'etk1',
    title: 'Review Q2 budget allocation across all teams',
    team_id: null,
    assigned_to: 'm1',
    assigned_by: null,
    status: 'in_progress',
  ...
  {
    id: 'etk2',
    title: 'Approve Healthcare team stock pitch presentation',
    team_id: 't1',
    assigned_to: 'm1',
    assigned_by: 'm4',
    status: 'pending',
  ...
  {
    id: 'etk3',
    title: 'Prepare board of directors quarterly report',
    team_id: null,
    assigned_to: 'm2',
    assigned_by: 'm1',
    status: 'in_progress',
  ...
  {
    id: 'etk4',
    title: 'Interview candidates for Junior PM position (Industrials)',
    team_id: 't5',
    assigned_to: 'm25',
    assigned_by: null,
    status: 'pending',
  ...
  {
    id: 'etk5',
    title: 'Strategic planning session - FY27 goals',
    team_id: null,
    assigned_to: 'm1',
    assigned_by: null,
    status: 'pending',
  ...
  {
    id: 'etk6',
    title: 'Review and approve TMT semiconductor thesis',
    team_id: 't7',
    assigned_to: 'm2',
    assigned_by: 'm3',
    status: 'completed',
  ...
  {
    id: 'etk7',
    title: 'Evaluate risk management protocols org-wide',
    team_id: null,
    assigned_to: 'm25',
    assigned_by: 'm1',
    status: 'in_progress',
  ...
  {
    id: 'etk8',
    title: 'Approve portfolio rebalancing recommendations',
    team_id: null,
    assigned_to: 'm1',
    assigned_by: 'm3',
    status: 'pending',
...
export const PORTFOLIO_MANAGER_TASKS = [
  {
    id: 'pmtk1',
    title: "Review Emma Liu's NVDA DCF model v3",
    team_id: 't7',
    assigned_to: 'm3',
    assigned_by: 'm10',
    status: 'in_progress',
  ...
  {
    id: 'pmtk2',
    title: 'Finalize TMT stock pitch deck for exec presentation',
    team_id: 't7',
    assigned_to: 'm3',
    assigned_by: 'm1',
    status: 'in_progress',
  ...
  {
    id: 'pmtk3',
    title: 'One-on-one meetings with all TMT analysts',
    team_id: 't7',
    assigned_to: 'm3',
    assigned_by: null,
    status: 'in_progress',
  ...
  {
    id: 'pmtk4',
    title: 'Update TMT portfolio risk metrics for quarterly review',
    team_id: 't7',
    assigned_to: 'm3',
    assigned_by: 'm2',
    status: 'pending',
  ...
  {
    id: 'pmtk5',
    title: 'Assign AMD coverage initiation to analyst',
    team_id: 't7',
    assigned_to: 'm3',
    assigned_by: null,
    status: 'completed',
  ...
  {
    id: 'pmtk6',
    title: 'Review Healthcare sector macro headwinds analysis',
    team_id: 't1',
    assigned_to: 'm4',
    assigned_by: 'm13',
    status: 'pending',
  ...
  {
    id: 'pmtk7',
    title: 'Prepare Energy team weekly sync agenda',
    team_id: 't3',
    assigned_to: 'm5',
    assigned_by: null,
    status: 'pending',
  ...
  {
    id: 'pmtk8',
    title: 'Review Financial Institutions Q1 performance attribution',
    team_id: 't4',
    assigned_to: 'm6',
    assigned_by: 'm1',
    status: 'in_progress',
...
export const ANALYST_TASKS = [
  {
    id: 'atk1',
    title: 'Complete NVDA DCF model with sensitivity analysis',
    team_id: 't7',
    assigned_to: 'm10',
    assigned_by: 'm3',
    status: 'in_progress',
  ...
  {
    id: 'atk2',
    title: 'Draft one-page MSFT investment thesis summary',
    team_id: 't7',
    assigned_to: 'm11',
    assigned_by: 'm3',
    status: 'in_progress',
  ...
  {
    id: 'atk3',
    title: 'Research AAPL India manufacturing expansion impact',
    team_id: 't7',
    assigned_to: 'm12',
    assigned_by: 'm3',
    status: 'pending',
  ...
  {
    id: 'atk4',
    title: 'Build AMD comparable company analysis model',
    team_id: 't7',
    assigned_to: 'm20',
    assigned_by: 'm3',
    status: 'in_progress',
  ...
  {
    id: 'atk5',
    title: 'Update META ad revenue forecast model',
    team_id: 't7',
    assigned_to: 'm20',
    assigned_by: 'm3',
    status: 'pending',
  ...
  {
    id: 'atk6',
    title: 'Complete AVGO VMware synergies analysis',
    team_id: 't7',
    assigned_to: 'm22',
    assigned_by: 'm3',
    status: 'in_progress',
  ...
  {
    id: 'atk7',
    title: 'Draft TSM geopolitical risk assessment memo',
    team_id: 't7',
    assigned_to: 'm23',
    assigned_by: 'm3',
    status: 'pending',
  ...
  {
    id: 'atk8',
    title: 'Build NFLX subscriber model with ad tier assumptions',
    team_id: 't7',
    assigned_to: 'm20',
    assigned_by: 'm3',
    status: 'pending',
  ...
  {
    id: 'atk9',
    title: 'Research CRWD platform consolidation thesis',
    team_id: 't7',
    assigned_to: 'm21',
    assigned_by: 'm3',
    status: 'in_progress',
  ...
  {
    id: 'atk10',
    title: 'Update TMT coverage universe watchlist',
    team_id: 't7',
    assigned_to: 'm24',
    assigned_by: 'm3',
    status: 'completed',
  ...
  t7: [
    {
      ...
      status: 'Active',
      rating: 'Buy',
      nextUpdate: '2026-04-15',
    },
    {
      ticker: 'AMD',
      analyst: 'Blackberry Analyst',
      status: 'Active',
      rating: 'Buy',
      nextUpdate: '2026-04-18',
    },
    {
      ticker: 'META',
      analyst: 'Blackberry Analyst',
    ...
    {
      ticker: 'AVGO',
      analyst: 'Sophia Nakamura',
      status: 'Active',
      rating: 'Buy',
      nextUpdate: '2026-04-16',
    },
    {
      ticker: 'TSM',
      analyst: 'Amir Hassan',
      status: 'Initiating',
      rating: 'TBD',
      nextUpdate: '2026-04-25',
    },
    {
      ticker: 'CRWD',
      analyst: 'Raj Venkatesh',
      status: 'Active',
      rating: 'Buy',
...
export const MOCK_DISCUSSIONS = [
  {
    ...
    content:
      'Updated the NVDA thesis — added AI data center TAM estimates. Please review before the pitch.',
    time: '2h ago',
    replies: 3,
    type: 'update',
  },
  {
    ...
    team_id: 't7',
    author: 'm10',
    author_name: 'Emma Liu',
    content:
      'Does anyone have access to the latest Gartner semiconductor forecast? Need it for the valuation model.',
    time: '5h ago',
    replies: 1,
    type: 'question',
  },
  {
    ...
    content:
      'Reminder: Healthcare portfolio review deliverables are due April 16. Please track progress in the event page.',
    time: '1d ago',
    replies: 2,
    type: 'announcement',
  },
  {
    ...
    content: 'Interesting read on the IRA impact on clean energy — sharing with the team.',
    time: '1d ago',
    replies: 5,
    type: 'discussion',
  },
  {
    ...
    team_id: null,
    author: 'm1',
    author_name: 'Jordan Nguyen',
    content:
      "Great work everyone on last week's presentations. Executive review notes will be shared by EOD.",
    time: '3d ago',
    replies: 8,
    type: 'announcement',
  },
  {
    ...
    content:
      'The JPM comparable model is ready for review. I used a PB/ROE regression — let me know if you want to discuss.',
    time: '4h ago',
    replies: 2,
    type: 'update',
  },
  {
    ...
    content:
      'Working through AAPL supply chain analysis. Found some interesting data on India manufacturing shift.',
    time: '6h ago',
    replies: 0,
    type: 'update',
  },
  ...
  // ─── NEW TMT Discussions ───
  {
    ...
    team_id: 't7',
    author: 'm20',
    author_name: 'Blackberry Analyst',
    content:
      'Started the AMD comps model — using NVDA, INTC, MRVL, and QCOM as the peer set. Any thoughts on including AVGO?',
    time: '1h ago',
    replies: 2,
    type: 'question',
  },
  {
    ...
    team_id: 't7',
    author: 'm21',
    author_name: 'Raj Venkatesh',
    content:
      "Semiconductor deep dive slide deck draft is up. I've outlined the AI infrastructure capex thesis — please review and add comments.",
    time: '3h ago',
    replies: 4,
    type: 'update',
  },
  {
    ...
    team_id: 't7',
    author: 'm22',
    author_name: 'Sophia Nakamura',
    content:
      "Running a sensitivity analysis on AVGO's VMware synergies. Initial numbers suggest 15-20% EPS accretion by FY27.",
    time: '8h ago',
    replies: 1,
    type: 'update',
  },
  {
    ...
    team_id: 't7',
    author: 'm24',
    author_name: 'Lily Tran',
    content:
      "Updated the TMT watchlist — added SMCI, ARM, and CRWD based on last week's discussion about AI infrastructure plays.",
    time: '1d ago',
    replies: 3,
    type: 'update',
  },
  {
    ...
    team_id: 't7',
    author: 'm23',
    author_name: 'Amir Hassan',
    content:
      'Any views on the T-Mobile/Sprint merger synergy realization? Working on a telecom primer and could use some input.',
    time: '2d ago',
    replies: 1,
    type: 'question',
  },
...
export const MOCK_TEAM_PERFORMANCE = [
  {
    ...
    change_pct: 1.8,
    change_dollar: 2520,
    top_holdings: ['UNH', 'JNJ', 'PFE', 'ABBV'],
    ytd_return: 8.4,
  },
  {
    team_id: 't2',
    team_name: 'Consumer Goods & Services',
    value: 118300,
    change_pct: -0.4,
    change_dollar: -475,
    top_holdings: ['PG', 'KO', 'NKE', 'COST'],
    ytd_return: 3.2,
  },
  {
    team_id: 't3',
  ...
  },
  {
    ...
    change_pct: 0.9,
    change_dollar: 1215,
    top_holdings: ['JPM', 'GS', 'MS', 'BAC'],
    ytd_return: 6.8,
  },
  {
    team_id: 't5',
    team_name: 'Industrials',
    value: 89400,
    change_pct: -1.2,
    change_dollar: -1088,
    top_holdings: ['CAT', 'HON', 'UNP', 'GE'],
    ytd_return: 2.1,
  },
  {
    team_id: 't6',
    team_name: 'Metals & Mining',
    value: 64200,
    change_pct: 3.4,
    change_dollar: 2110,
    top_holdings: ['NEM', 'FCX', 'BHP', 'RIO'],
    ytd_return: 18.9,
  },
  {
    team_id: 't7',
    ...
    change_pct: 1.5,
    change_dollar: 2935,
    top_holdings: ['NVDA', 'AAPL', 'MSFT', 'META'],
    ytd_return: 14.2,
  },
];
...
export const MOCK_TMT_RESEARCH_PIPELINE = [
  {
    ticker: 'NVDA',
    analyst_id: 'm10',
    analyst_name: 'Emma Liu',
    status: 'active',
    rating: 'Buy',
    target_price: 950,
    thesis: 'AI data center TAM expansion',
  },
  {
    ticker: 'AMD',
    analyst_id: 'm20',
    analyst_name: 'Blackberry Analyst',
    status: 'active',
    rating: 'Buy',
    target_price: 195,
    thesis: 'AI GPU market share gains from MI300X',
  },
  {
    ticker: 'META',
    analyst_id: 'm20',
    ...
    rating: 'Hold',
    target_price: 530,
    thesis: 'Ad revenue stabilization, Reels monetization',
  },
  {
    ticker: 'AVGO',
    analyst_id: 'm22',
    analyst_name: 'Sophia Nakamura',
    status: 'active',
    rating: 'Buy',
    target_price: 1500,
    thesis: 'VMware integration + AI ASIC opportunity',
  },
  {
    ticker: 'CRWD',
    analyst_id: 'm21',
    analyst_name: 'Raj Venkatesh',
    status: 'active',
    rating: 'Buy',
    target_price: 400,
    thesis: 'Platform consolidation in cybersecurity',
  },
  {
    ticker: 'TSM',
    analyst_id: 'm23',
    analyst_name: 'Amir Hassan',
    status: 'initiating',
    rating: 'Pending',
    target_price: null,
    thesis: 'Advanced node monopoly + geopolitical risk',
  },
  {
    ticker: 'NFLX',
    analyst_id: 'm20',
    ...
    rating: 'Hold',
    target_price: 650,
    thesis: 'Ad tier growth, password sharing crackdown',
  },
  {
    ticker: 'SMCI',
    analyst_id: 'm21',
    ...
    rating: 'Pending',
    target_price: null,
    thesis: 'AI server rack leader, but governance concerns',
  },
];

// ── Permission tiers ──
// PERMISSION_TIERS moved to src/lib/org-permissions-config.js (Phase D2) — it is
// REAL shared config, not mock data. Import it (and getMemberPermissions /
// canFlagPositions / getManageableOrgPeers) from there.
...
export function getManageableMembers(supervisor) {
  ...
  if (supervisor.role === 'portfolio_manager') {
    return MOCK_MEMBERS.filter((m) => m.role === 'analyst' && m.team_id === supervisor.team_id);
  }
  return [];
}

// getManageableOrgPeers, getMemberPermissions, canFlagPositions moved to
// src/lib/org-permissions-config.js (Phase D2) — real shared config, not mock.
...
export function getOrgMemberReportsTo(member) {
  ...
  if (member.role === 'analyst') {
    return (
      MOCK_MEMBERS.find((m) => m.role === 'portfolio_manager' && m.team_id === member.team_id) ||
      null
    );
  }
