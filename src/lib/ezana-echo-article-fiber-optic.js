...
export const FIBER_OPTIC_COMPANIES = [
  ...
  {
    name: 'Finisar (now Coherent)',
    lat: -33.87,
    lng: 151.21,
    country: 'AU',
    continent: 'Oceania',
    industry: 'Telecom',
    hq: 'Sydney, Australia (APAC ops)',
  },
];
...
export const fiberOpticArticle = {
  ...
  contentBlocks: [
    ...
    },
    {
      ...
      caption:
        'PPI for Fiber Optic Cable Manufacturing (NAICS 335921). Dec 2003 = 100. Source: FRED / Bureau of Labor Statistics.',
      dataKey: 'fredPpi',
    ...
    {
      type: 'heading',
      text: 'The $30 Billion Question: Where The Growth Is Coming From',
      level: 2,
    },
    {
      type: 'paragraph',
    ...
    },
    {
      ...
      caption:
        'Market size in USD billions by application segment. Source: Industry research estimates.',
    ...
    {
      type: 'heading',
      text: 'Corning: The 175-Year-Old Company That Is Outrunning Nvidia',
      level: 2,
    },
    {
      type: 'paragraph',
    ...
    },
    {
      ...
      value: '+74% YTD',
      context:
        'Outperforming Nvidia, Broadcom, and AMD in 2025 — on fiber optic cable demand from AI data centers.',
    },
    {
      type: 'paragraph',
    ...
    },
    {
      ...
      stats: [
        ...
        {
          label: 'New Factory',
          value: 'Broke ground Mar 2026',
          change: 'Dedicated Meta production',
        },
        {
          label: 'Q1 2026 Earnings',
          value: '2 new hyperscale deals',
          change: 'AI-driven upside guidance',
        },
      ],
    },
    {
