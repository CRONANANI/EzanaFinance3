...
/**
 * Interactive shell for the Stock Pitch Pipeline. This is everything the page
 * used to render as a client component (org gate, hero, composer modal, and the
 * boardKey refresh pattern); the page itself is now a Server Component that
 * loads the initial kanban board and hands it down as `initialBoard`.
 */
export function PitchPipelineClient({ initialBoard = null }) {
  ...
  return (
    <div className="dashboard-page-inset th-page op-page">
      ...
      />
      <PitchWorkspace refreshKey={boardKey} initialData={initialBoard} />
    </div>
  );
}
