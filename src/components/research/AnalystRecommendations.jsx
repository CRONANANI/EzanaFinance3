    ...
    return (
      ...
      >
        <div className="text-center py-8">
          ...
          <p className="text-gray-400">Analyst data not available</p>
        </div>
      </motion.div>
    );
  }
        ...
        <div className="space-y-3 mb-6">
          {recommendationData.map((rec) => (
            <div key={rec.label} className="flex items-center gap-3">
              <span className="text-sm text-gray-400 w-24 flex-shrink-0">{rec.label}</span>
              ...
              <span className="text-white font-semibold w-6 text-right">{rec.value}</span>
            </div>
          ))}
        </div>
      )}
        ...
        <div className="pt-4 border-t border-gray-700">
          ...
          <div className="grid grid-cols-3 gap-3">
            <div className="bg-[#161b22] rounded-xl p-3 text-center">
              ...
              <p className="text-red-400 font-semibold">{formatPrice(priceTarget.targetLow)}</p>
            </div>
            <div className="bg-emerald-500/10 rounded-xl p-3 text-center border border-emerald-500/20">
              <p className="text-xs text-emerald-400 mb-1">Mean</p>
            ...
            <div className="bg-[#161b22] rounded-xl p-3 text-center">
              ...
              <p className="text-emerald-400 font-semibold">{formatPrice(priceTarget.targetHigh)}</p>
            </div>
          </div>
        </div>
      )}
