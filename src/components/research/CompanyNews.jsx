...
export function CompanyNews({ symbol, className = '' }) {
  ...
  return (
    <motion.div
      ...
      className={`research-card bg-white dark:bg-[#0d1117] border border-gray-200 dark:border-gray-700 rounded-xl p-6 ${className}`}
    >
      <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Company News</h3>
      <div className="space-y-4 max-h-[400px] overflow-y-auto">
        {data.map((item) => (
          <a
            ...
            className="block p-3 rounded-lg bg-gray-100 dark:bg-[#161b22] hover:bg-gray-200 dark:hover:bg-[#1c2128] transition-colors group"
          >
            <div className="flex gap-3">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-gray-900 dark:text-white font-medium group-hover:text-emerald-600 dark:group-hover:text-emerald-400 line-clamp-2">
                  {item.headline}
                </p>
