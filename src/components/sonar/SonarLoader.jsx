...
import './sonar-loader.css';

/* Stacked-platform loader for Sonar pings, adapted from Noah's 21st.dev
   reference. Converted: no styled-components, no TS, palette derived from
   Ezana tokens via component-scoped custom props (see CSS). Decorative. */

export function SonarLoader({ caption = 'Sweeping the field...' }) {
  return (
    <div className="snrl-wrap">
      <div className="snrl-stack" aria-hidden="true">
        <div className="snrl-mini">
          <svg
            width="74"
            height="90"
            viewBox="0 0 74 90"
          ...
          >
            ...
            <path
              ...
              fill="var(--snrl-mid)"
            />
            <path d="M34 76.5H40V90H34V76.5Z" fill="var(--snrl-mid)" />
            <path
            ...
            <path
              ...
              fill="var(--snrl-deep)"
            />
            <path d="M34 79L3 61V71.5751L34 90V79Z" fill="var(--snrl-bright)" />
            <path
              className="snrl-strobe-a"
              d="M58 72.5L60.5 71V74L58 75.5V72.5Z"
              fill="var(--snrl-led)"
            />
            <path
              className="snrl-strobe-b"
              d="M63 69.5L65.5 68V71L63 72.5V69.5Z"
              fill="var(--snrl-led)"
            />
            <path d="M68 66.5L70.5 65V68L68 69.5V66.5Z" fill="var(--snrl-led)" />
            <path
            ...
            <path
              ...
              fill="var(--snrl-mid)"
            />
            <path d="M34 58.5H40V72H34V58.5Z" fill="var(--snrl-mid)" />
            <path
            ...
            <path
              ...
              fill="var(--snrl-deep)"
            />
            <path d="M34 61L3 43V53.5751L34 72V61Z" fill="var(--snrl-bright)" />
            <path d="M58 54.5L60.5 53V56L58 57.5V54.5Z" fill="var(--snrl-led)" />
            <path
              className="snrl-strobe-a"
              d="M63 51.5L65.5 50V53L63 54.5V51.5Z"
              fill="var(--snrl-led)"
            />
            <path d="M68 48.5L70.5 47V50L68 51.5V48.5Z" fill="var(--snrl-led)" />
            <path
            ...
            <path
              ...
              fill="var(--snrl-mid)"
            />
            <path d="M34 40.5H40V54H34V40.5Z" fill="var(--snrl-mid)" />
            <path
            ...
            <path
              ...
              fill="var(--snrl-deep)"
            />
            <path d="M34 43L3 25V35.5751L34 54V43Z" fill="var(--snrl-bright)" />
            <path d="M68 30.5L70.5 29V32L68 33.5V30.5Z" fill="var(--snrl-led)" />
            <path
              className="snrl-strobe-c"
              d="M58 36.5L60.5 35V38L58 39.5V36.5Z"
              fill="var(--snrl-led)"
            />
            <path d="M63 33.5L65.5 32V35L63 36.5V33.5Z" fill="var(--snrl-led)" />
            <path
        ...
        <div className="snrl-ghost">
          ...
          >
            <path
              ...
              fill="var(--snrl-shadow)"
            />
          </svg>
        </div>
      </div>
      <p className="snrl-caption" role="status">
        {caption}
      </p>
    </div>
  );
