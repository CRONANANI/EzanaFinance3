...
const QUICK_LINKS = [
  {
    ...
    label: 'Dashboard',
    desc: 'Revenue, copiers, and performance',
    color: '#10b981',
  },
  {
    ...
    icon: 'bi-people',
    label: 'Community',
    desc: 'Engage followers and copiers',
    color: '#3b82f6',
  },
  {
    ...
    desc: 'Build courses and content',
    color: '#a78bfa',
  },
  {
    href: '/settings',
...
const ACTIVITY_FEED = [
  {
    type: 'copier',
    text: 'Alex M. started copying your portfolio',
    time: '12 min ago',
    icon: 'bi-person-plus',
    color: '#10b981',
  },
  {
    type: 'commission',
    text: 'Commission earned: $47.20 from copy trades',
    time: '1 hour ago',
    icon: 'bi-cash-coin',
    color: '#fbbf24',
  },
  {
    type: 'course',
    text: '3 new enrollments in "Options Trading Basics"',
    time: '3 hours ago',
    icon: 'bi-mortarboard',
    color: '#a78bfa',
  },
  {
    type: 'follower',
    text: 'Sarah K. followed your profile',
    time: '5 hours ago',
    icon: 'bi-heart',
    color: '#f472b6',
  },
  {
    type: 'copier',
    text: 'Mark R. copied your NVDA position',
    time: '8 hours ago',
  ...
  {
    type: 'payout',
    text: 'Monthly payout of $2,340.00 processed',
    time: '1 day ago',
    icon: 'bi-bank',
    color: '#3b82f6',
  },
    ...
    <div className="ptr-page">
      <div className="ptr-hero">
        <div className="ptr-hero-left">
          ...
          <h1 className="ptr-hero-title">
            {getGreeting()}, {displayName}
          </h1>
          <p className="ptr-hero-sub">
            Welcome to your Partner Hub. Manage your strategies, grow your audience, and track your
            earnings.
          </p>
