  ...
  return (
    <div className="gcx-ai">
      ...
      <p className="gcx-ai-disclaimer">
        Generated by Claude from this award&apos;s public USAspending record. Not investment advice,
        not reported fact, and not verified against outside sources.
      </p>
...
function AwardDetailModal({ award: a, onClose }) {
  ...
  return (
    <div className="gcx-modal-backdrop" onClick={onClose}>
      <div
        className="gcx-modal gcx-award-modal"
