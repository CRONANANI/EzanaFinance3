-- ═══════════════════════════════════════════════════════════
-- FIX: Missing partners columns + Isabel full-access setup
--
-- Safe to re-run. ALTER TABLE adds columns to an existing partners
-- table (CREATE TABLE IF NOT EXISTS cannot do that).
-- PREREQUISITE: isabel.lim546@gmail.com must exist in auth.users.
-- ═══════════════════════════════════════════════════════════

-- STEP 1: Catch up partners table with all expected columns
...
-- STEP 2: Isabel full-access setup
